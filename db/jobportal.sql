...
CREATE TABLE `company` (
  ...
  `About_Us` varchar(100) DEFAULT NULL,
  `Type` varchar(100) NOT NULL,
  `Image` varchar(100) DEFAULT NULL,
  `Establish_Year` varchar(100) DEFAULT NULL
...
INSERT INTO `company` (`Email`, `Password`, `Name`, `Address`, `Contact`, `About_Us`, `Type`, `Image`, `Establish_Year`) VALUES
('company@gmail.com', '123', 'CPC', 'Kolkata', '8981887239', 'My Company teach students of BCA, MCA, BTech', 'Teaching', 'profile/ssa.jpg', '1990-01-10'),
('mky061445@gmail.com', '12355', 'cpc education', 'kolkata', '07903588014', 'good ', 'institute', 'http://localhost:9090/Job_Portal/images/Screenshot (1).png', NULL),
('mky765@gmail.com', '5869', 'tcs', 'brahampur', '987654321', 'good ', 'institute', 'http://localhost:9090/Job_Portal/images/Screenshot (7).png', '1996-12-20'),
('py06748@gmail.com', '258', 'cpc education', 'kolkata', '07903588014', 'good ', 'institute', 'http://localhost:9090/Job_Portal/images/cpc.jpg', NULL),
('rink802112@gmail.com', '8523', 'rinkuEducation', 'buxar', '9123115744', 'good ', 'institute', 'http://localhost:9090/Job_Portal/images/Screenshot (8).png', '2016-02-20'),
('rink802121@gmail.com', '4561', 'tcs', 'patna', '9123115744', 'good ', 'it', 'http://localhost:9090/Job_Portal/images/Screenshot (7).png', NULL);
...
CREATE TABLE `job_applied` (
  ...
  `Job_Seeker_Email` varchar(100) NOT NULL,
...
INSERT INTO `job_applied` (`Applied_Id`, `Post_Id`, `Job_Seeker_Email`, `Company_Email`, `Applied_Date`, `Job_Status`) VALUES
(1, '1', 'seeker@gmail.com', 'company@gmail.com', '23/09/2020', 'pending');
...
CREATE TABLE `job_posted` (
  ...
  `job_cat` varchar(100) DEFAULT NULL,
  `job_post_name` varchar(100) NOT NULL,
  `job_post_date` varchar(300) NOT NULL,
  `job_last_date` varchar(300) NOT NULL,
...
INSERT INTO `job_posted` (`job_post_Id`, `email`, `job_type`, `job_cat`, `job_post_name`, `job_post_date`, `job_last_date`, `qualification`, `package`, `location`, `skills`, `status`) VALUES
(1, 'company@gmail.com', 'fulltime', 'Web Designing', 'Front End Developer', '2020-09-05', '2020-08-20', 'Intermediate', '10000/- per month', 'Kolkata,24', 'HTML, CSS, JS, JQ, Bootstrap', 1),
(4, 'company@gmail.com', 'fulltime', 'Software Development', 'Java Programmer', '2020-09-05', '2020-08-22', 'BCA, Btech', '3.4 L/A', 'Kolkata,24', 'Java, Spring, Bootstrap', 0);
...
INSERT INTO `job_seeker_registration` (`user_email`, `user_password`, `user_name`, `address`, `qualification`, `skills`, `resume`, `contact`, `gender`, `language`, `dob`, `image`) VALUES
('py06748@gmail.com', '12345', 'priyanshu', 'kolkata', 'b.tech', NULL, NULL, '07903588014', 'male', NULL, NULL, NULL),
('seeker@gmail.com', '123', 'Seeker', 'Dhanbad', 'Phd', NULL, NULL, '8981887239', 'male', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `shortlisted_job_seeker`
--

CREATE TABLE `shortlisted_job_seeker` (
  `Shortlisted_Id` varchar(100) NOT NULL,
  `Post_Id` varchar(100) NOT NULL,
  `Job_Seeker_Email` varchar(100) NOT NULL,
  `Company_Email` varchar(100) NOT NULL,
  `Shortlisted_Date` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `shortlisted_job_seeker`
--
ALTER TABLE `shortlisted_job_seeker`
